"""
-----------------------------------------------------------------------------
FILE: server/blog_generator/services.py
PURPOSE: Core business logic for video processing, transcription, and synthesis.
...
def process_video_to_blog_task(user, link, task_id=None):
    """
    Orchestrates the 'Video -> Audio -> Text -> Synthesis' pipeline.
    Executed as a background task via Django-Q.
    """
    try:
