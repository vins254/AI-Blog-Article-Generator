...
# Using CompressedManifestStaticFilesStorage for cache busting (hashed filenames).
# WHITENOISE_MANIFEST_STRICT = False ensures the app doesn't crash if a file is missing.
